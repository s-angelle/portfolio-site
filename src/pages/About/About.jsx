  ...
  return (
    <div id="about-main-div">
      <div id="author-image-div">
        <img className="animate__animated animate__bounceIn" src={AuthorPhoto} id="author-photo" />
      </div>
      <article id="about-article">
        <h2 id="about-heading" >About Me</h2>
        <p className="animate__animated animate__fadeIn animate__delay-1s"id='about-text'>
